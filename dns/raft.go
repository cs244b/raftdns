// Below code is mostly adapted from contrib/raftexample by etcd
// It provides many things we need like snapshotting and WAL,
// so we choose not to write from scratch
// Copyright 2015 The etcd Authors. Apache License 2.0
